...
public class MovieBeans {
 ...
 private String trailer_url;
    ...
    public MovieBeans(int id, String title, String genre, LocalDate release_date, String language, int rating, String production_company, String country, int age_rating, String poster_url, int duration, String description , String trailer_url) {
        this.id = id;
        this.title = title;
        this.genre = genre;
